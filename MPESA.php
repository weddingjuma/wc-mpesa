...
class Mpesa
{
    ...
    */
    ...
    public function confirm(){
        $resultArray = array( "ResultDesc"=>"Confirmation Service request accepted successfully", "ResultCode"=>"0" );
    ...
    public function decline(){
        $resultArray = array( "ResultDesc"=>"Confirmation Service request declined", "ResultCode"=>"1" );
